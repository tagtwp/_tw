...
if ( ! function_exists( '_twp_register_required_plugins' ) ) {
	function _twp_register_required_plugins() {
		...
		$plugins = [
			[
				'name'               => esc_html__( '_TWP Core', '_twp' ),
				'slug'               => 'twp-core',
		...
		$_twp_config = [
			...
			'strings'      => [
				...
				'notice_can_install_required'     => _n_noop( '_TWP the following plugin: %1$s.', '_TWP requires the following plugins: %1$s.', '_twp' ),
				'notice_can_install_recommended'  => _n_noop( '_TWP recommends the following plugin: %1$s.', '_TWP recommends the following plugins: %1$s.', '_twp' ),
				...
				'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with _TWP: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with _TWP: %1$s.', '_twp' ),
